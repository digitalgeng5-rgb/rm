...
name: ru-check
description: >
  [RU] Вычитка русского текста по корпусу ru-text. Вызывай при: вычитка, типографика,
  нейрослоп, редактура, UX-тексты, деловая переписка, «вычитай», ru-check, ru-text.
  Findings + rule + replacement; never edits a file. Explicit ask = full corpus.
