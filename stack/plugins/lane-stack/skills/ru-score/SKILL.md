...
name: ru-score
description: >
  [RU] Балл 0–10 за качество русского текста. Вызывай при: оцени текст, ru-score,
  оценка качества, балл — или когда работа над качеством русского текста и нужен
  номер, не список правок. Never edits a file.
